...
import 'package:court_pass/custom%20widgets/buttons/white_button.dart';
...
class ReservationRequest extends StatefulWidget {
  ...
  @override
  State<ReservationRequest> createState() => _ReservationRequestState();
}
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            bottom: 0, // Reserve space for bottom container
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        'Remaining payments will be done at the facility',
                        style: TextStyle(
